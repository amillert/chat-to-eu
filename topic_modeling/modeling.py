...
class Modeler:
    def __init__(self, tmp_path, paragraph_tokens=None, load=True):
        ...
        if load == True:
            ...
            lda_model = gensim.models.ldamodel.LdaModel(corpus=corpus, id2word=idx2word, num_topics=20, update_every=1, chunksize=100, passes=20, alpha='auto', per_word_topics=True)
    ...
    def read_model(self):
        return gensim.model.ldamodel.LdaModel(load(self.tmp_path + "lda"))
